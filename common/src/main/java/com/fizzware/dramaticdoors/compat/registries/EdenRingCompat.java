...
public class EdenRingCompat 
{
	...
	private static void registerBlocksItems() {
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_AURITIS, DDNames.SHORT_AURITIS, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("edenring", "auritis_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_BALLOON_MUSHROOM, DDNames.SHORT_BALLOON_MUSHROOM, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("edenring", "balloon_mushroom_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_BRAIN_TREE, DDNames.SHORT_BRAIN_TREE, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("edenring", "brain_tree_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_PULSE_TREE, DDNames.SHORT_PULSE_TREE, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("edenring", "pulse_tree_door")), true, DDRegistry.MAIN_TAB);
	}
