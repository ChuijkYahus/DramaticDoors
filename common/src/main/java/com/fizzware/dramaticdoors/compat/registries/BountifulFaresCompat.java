...
public class BountifulFaresCompat 
{
	...
	private static void registerBlocksItems() {
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_BF_CERAMIC, DDNames.SHORT_BF_CERAMIC, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("bountifulfares", "ceramic_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_BF_HOARY, DDNames.SHORT_BF_HOARY, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("bountifulfares", "ceramic_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_BF_WALNUT, DDNames.SHORT_BF_WALNUT, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("bountifulfares", "ceramic_door")), true, DDRegistry.MAIN_TAB);
	}
