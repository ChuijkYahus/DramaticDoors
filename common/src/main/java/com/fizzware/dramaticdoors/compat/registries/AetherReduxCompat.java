...
public class AetherReduxCompat
{
	...
	private static void registerBlocksItems() {
		...
		//DDRegistry.registerDoorBlockAndItem(DDNames.TALL_PRISMATIC, DDNames.SHORT_PRISMATIC, DDRegistry.getBlockFromResourceLocation(ResourceLocation.fromNamespaceAndPath("aether_redux", "prismatic_door")), BlockSetType.OAK, true); // Legacy content.
	...
	private static void registerRecipes() {
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_BLIGHTWILLOW, ResourceLocation.fromNamespaceAndPath("aether_redux", "skyroot_door"));
		...
		//DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_PRISMATIC, ResourceLocation.fromNamespaceAndPath("aether_redux", "prismatic_door"));
		...
		DDCompatAdvancement.createRecipeAdvancement(DDNames.TALL_BLIGHTWILLOW, ResourceLocation.fromNamespaceAndPath("aether_redux", "skyroot_door"));
		...
		//DDCompatAdvancement.createRecipeAdvancement(DDNames.TALL_PRISMATIC, ResourceLocation.fromNamespaceAndPath("aether_redux", "prismatic_door"));
		...
		DDCompatRecipe.createShortDoorRecipe(DDNames.SHORT_BLIGHTWILLOW, ResourceLocation.fromNamespaceAndPath("aether_redux", "skyroot_door"), true);
		...
		//DDCompatRecipe.createShortDoorRecipe(DDNames.SHORT_PRISMATIC, ResourceLocation.fromNamespaceAndPath("aether_redux", "prismatic_door"), true);
		...
		DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_BLIGHTWILLOW, ResourceLocation.fromNamespaceAndPath("aether_redux", "skyroot_door"), "tall_wooden_door");
		...
		//DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_PRISMATIC, ResourceLocation.fromNamespaceAndPath("aether_redux", "prismatic_door"), "tall_wooden_door");
