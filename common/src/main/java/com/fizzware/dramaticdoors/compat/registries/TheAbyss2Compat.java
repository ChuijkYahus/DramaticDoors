...
public class TheAbyss2Compat 
{
	...
	private static void registerBlocksItems() {
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_BLARU, DDNames.SHORT_BLARU, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("theabyss", "blaru_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_BOG, DDNames.SHORT_BOG, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("theabyss", "bog_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_FROZEN, DDNames.SHORT_FROZEN, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("theabyss", "frozen_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_ABYSSAL_JUNGLE, DDNames.SHORT_ABYSSAL_JUNGLE, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("theabyss", "jungle_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_SAL, DDNames.SHORT_SAL, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("theabyss", "sal_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_SLIMED, DDNames.SHORT_SLIMED, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("theabyss", "slimed_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_VIGILANT, DDNames.SHORT_VIGILANT, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("theabyss", "vigilant_door")), true, DDRegistry.MAIN_TAB);
	}
