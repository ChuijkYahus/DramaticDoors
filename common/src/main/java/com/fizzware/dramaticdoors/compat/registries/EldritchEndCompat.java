...
public class EldritchEndCompat 
{
	...
	private static void registerBlocksItems() {
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_ETYR, DDNames.SHORT_ETYR, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("eldritch_end", "etyr_door"), Blocks.IRON_DOOR), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_CORRUPTED_ETYR, DDNames.SHORT_CORRUPTED_ETYR, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("eldritch_end", "corrupted_etyr_door"), Blocks.IRON_DOOR), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_DECADENT_ETYR, DDNames.SHORT_DECADENT_ETYR, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("eldritch_end", "decadent_etyr_door"), Blocks.IRON_DOOR), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_PERTURBED_ETYR, DDNames.SHORT_PERTURBED_ETYR, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("eldritch_end", "perturbed_etyr_door"), Blocks.IRON_DOOR), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_PRIMORDIAL, DDNames.SHORT_PRIMORDIAL, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("eldritch_end", "primordial_door")), true, DDRegistry.MAIN_TAB);
	}
