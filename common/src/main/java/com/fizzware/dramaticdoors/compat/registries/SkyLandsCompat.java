...
public class SkyLandsCompat 
{
	...
	private static void registerBlocksItems() {
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_FIERY_PLANKS, DDNames.SHORT_FIERY_PLANKS, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("flying_stuff", "fiery_planks_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_LAVIC_PLANKS, DDNames.SHORT_LAVIC_PLANKS, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("flying_stuff", "lavic_planks_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_GLACIATED, DDNames.SHORT_GLACIATED, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("flying_stuff", "glaciated_planks_door")), true, DDRegistry.MAIN_TAB);
	}
