...
public class ImmersiveWeatheringCompat 
{
	...
	private static void registerBlocksItems() {
		Block shortExposedIronDoor = new ShortWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("immersive_weathering", "exposed_iron_door"), Blocks.IRON_DOOR), WeatherState.EXPOSED);
		Block shortWeatheredIronDoor = new ShortWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("immersive_weathering", "weathered_iron_door"), Blocks.IRON_DOOR), WeatherState.WEATHERED);
		Block shortRustedIronDoor = new ShortWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("immersive_weathering", "oxidized_iron_door"), Blocks.IRON_DOOR), WeatherState.OXIDIZED);
		Block shortWaxedIronDoor = new ShortWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("immersive_weathering", "waxed_iron_door"), Blocks.IRON_DOOR), WeatherState.UNAFFECTED);
		Block shortWaxedExposedIronDoor = new ShortWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("immersive_weathering", "waxed_exposed_iron_door"), Blocks.IRON_DOOR), WeatherState.EXPOSED);
		Block shortWaxedWeatheredIronDoor = new ShortWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("immersive_weathering", "waxed_weathered_iron_door"), Blocks.IRON_DOOR), WeatherState.WEATHERED);
		Block shortWaxedRustedIronDoor = new ShortWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("immersive_weathering", "waxed_oxidized_iron_door"), Blocks.IRON_DOOR), WeatherState.OXIDIZED);
		Block tallExposedIronDoor = new TallWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("immersive_weathering", "exposed_iron_door"), Blocks.IRON_DOOR), WeatherState.EXPOSED);
		Block tallWeatheredIronDoor =  new TallWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("immersive_weathering", "weathered_iron_door"), Blocks.IRON_DOOR), WeatherState.WEATHERED);
		Block tallRustedIronDoor = new TallWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("immersive_weathering", "oxidized_iron_door"), Blocks.IRON_DOOR), WeatherState.OXIDIZED);
		Block tallWaxedIronDoor = new TallWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("immersive_weathering", "waxed_iron_door"), Blocks.IRON_DOOR), WeatherState.UNAFFECTED);
		Block tallWaxedExposedIronDoor = new TallWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("immersive_weathering", "waxed_exposed_iron_door"), Blocks.IRON_DOOR), WeatherState.EXPOSED);
		Block tallWaxedWeatheredIronDoor = new TallWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("immersive_weathering", "waxed_weathered_iron_door"), Blocks.IRON_DOOR), WeatherState.WEATHERED);
		Block tallWaxedRustedIronDoor = new TallWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("immersive_weathering", "waxed_oxidized_iron_door"), Blocks.IRON_DOOR), WeatherState.OXIDIZED);
