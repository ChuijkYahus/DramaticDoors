...
public class NaturesSpiritCompat
{
	...
	private static void registerBlocksItems() {
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_NS_ASPEN, DDNames.SHORT_NS_ASPEN, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("natures_spirit", "aspen_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_NS_CEDAR, DDNames.SHORT_NS_CEDAR, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("natures_spirit", "cedar_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_NS_COCONUT, DDNames.SHORT_NS_COCONUT, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("natures_spirit", "coconut_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_NS_CYPRESS, DDNames.SHORT_NS_CYPRESS, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("natures_spirit", "cypress_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_NS_FIR, DDNames.SHORT_NS_FIR, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("natures_spirit", "fir_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_NS_GHAF, DDNames.SHORT_NS_GHAF, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("natures_spirit", "ghaf_door")),true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_NS_JOSHUA, DDNames.SHORT_NS_JOSHUA, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("natures_spirit", "joshua_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_NS_LARCH, DDNames.SHORT_NS_LARCH, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("natures_spirit", "larch_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_NS_MAHOGANY, DDNames.SHORT_NS_MAHOGANY, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("natures_spirit", "mahogany_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_NS_MAPLE, DDNames.SHORT_NS_MAPLE, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("natures_spirit", "maple_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_NS_OLIVE, DDNames.SHORT_NS_OLIVE, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("natures_spirit", "olive_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_NS_PALO_VERDE, DDNames.SHORT_NS_PALO_VERDE, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("natures_spirit", "palo_verde_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_NS_REDWOOD, DDNames.SHORT_NS_REDWOOD, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("natures_spirit", "redwood_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_NS_SAXAUL, DDNames.SHORT_NS_SAXAUL, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("natures_spirit", "saxaul_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_NS_SUGI, DDNames.SHORT_NS_SUGI, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("natures_spirit", "sugi_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_NS_WILLOW, DDNames.SHORT_NS_WILLOW, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("natures_spirit", "willow_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_NS_WISTERIA, DDNames.SHORT_NS_WISTERIA, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("natures_spirit", "wisteria_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_NS_PAPER, DDNames.SHORT_NS_PAPER, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("natures_spirit", "paper_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_NS_FRAMED_PAPER, DDNames.SHORT_NS_FRAMED_PAPER, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("natures_spirit", "framed_paper_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_NS_BLOOMING_PAPER, DDNames.SHORT_NS_BLOOMING_PAPER, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("natures_spirit", "blooming_paper_door")), true, DDRegistry.MAIN_TAB);
	}
