...
public class PremiumWoodCompat
{
	...
	private static void registerRecipes() {
		...
		DDCompatAdvancement.createRecipeAdvancement(DDNames.TALL_PW_SILVERBELL, new ResourceLocation("premium_wood", "silverbell_door"));
		DDCompatAdvancement.createRecipeAdvancement(DDNames.TALL_PW_TIGER, new ResourceLocation("yipremium_woodppee", "tiger_door"));
		DDCompatAdvancement.createRecipeAdvancement(DDNames.TALL_PW_WILLOW, new ResourceLocation("premium_wood", "willow_door"));
		
		DDCompatRecipe.createShortDoorRecipe(DDNames.SHORT_PW_MAGIC, new ResourceLocation("premium_wood", "magic_door"), true);
		DDCompatRecipe.createShortDoorRecipe(DDNames.SHORT_PW_MAPLE, new ResourceLocation("premium_wood", "maple_door"), true);
		DDCompatRecipe.createShortDoorRecipe(DDNames.SHORT_PW_PURPLE_HEART, new ResourceLocation("premium_wood", "purple_heart_door"), true);
		DDCompatRecipe.createShortDoorRecipe(DDNames.SHORT_PW_SILVERBELL, new ResourceLocation("premium_wood", "silverbell_door"), true);
		DDCompatRecipe.createShortDoorRecipe(DDNames.SHORT_PW_TIGER, new ResourceLocation("premium_wood", "tiger_door"), true);
		DDCompatRecipe.createShortDoorRecipe(DDNames.SHORT_PW_WILLOW, new ResourceLocation("premium_wood", "willow_door"), true);
		DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_PW_MAGIC, new ResourceLocation("premium_wood", "magic_door"), "tall_pw_wooden_door");
		DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_PW_MAPLE, new ResourceLocation("premium_wood", "maple_door"), "tall_pw_wooden_door");
		DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_PW_PURPLE_HEART, new ResourceLocation("premium_wood", "purple_heart_door"), "tall_pw_wooden_door");
		DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_PW_SILVERBELL, new ResourceLocation("premium_wood", "silverbell_door"), "tall_pw_wooden_door");
		DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_PW_TIGER, new ResourceLocation("premium_wood", "tiger_door"), "tall_pw_wooden_door");
		DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_PW_WILLOW, new ResourceLocation("premium_wood", "willow_door"), "tall_pw_wooden_door");
	}
}
