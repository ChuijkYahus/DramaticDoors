...
public class TrickyTrialsBackportCompat 
{
	...
	private static void registerBlocksItems() {
		Block shortCopperDoor = new ShortWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("copperandtuffbackport", "copper_door"), Blocks.COPPER_BLOCK), WeatherState.UNAFFECTED);
		Block shortExposedCopperDoor = new ShortWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("copperandtuffbackport", "exposed_copper_door"), Blocks.COPPER_BLOCK), WeatherState.EXPOSED);
		Block shortWeatheredCopperDoor = new ShortWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("copperandtuffbackport", "weathered_copper_door"), Blocks.COPPER_BLOCK), WeatherState.WEATHERED);
		Block shortOxidizedCopperDoor = new ShortWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("copperandtuffbackport", "oxidized_copper_door"), Blocks.COPPER_BLOCK), WeatherState.OXIDIZED);
		Block shortWaxedCopperDoor = new ShortWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("copperandtuffbackport", "waxed_copper_door"), Blocks.COPPER_BLOCK), WeatherState.UNAFFECTED);
		Block shortWaxedExposedCopperDoor = new ShortWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("copperandtuffbackport", "waxed_exposed_copper_door"), Blocks.COPPER_BLOCK), WeatherState.EXPOSED);
		Block shortWaxedWeatheredCopperDoor = new ShortWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("copperandtuffbackport", "waxed_weathered_copper_door"), Blocks.COPPER_BLOCK), WeatherState.WEATHERED);
		Block shortWaxedOxidizedCopperDoor = new ShortWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("copperandtuffbackport", "waxed_oxidized_copper_door"), Blocks.COPPER_BLOCK), WeatherState.OXIDIZED);
		Block tallCopperDoor = new TallWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("copperandtuffbackport", "copper_door"), Blocks.COPPER_BLOCK), WeatherState.UNAFFECTED);
		Block tallExposedCopperDoor = new TallWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("copperandtuffbackport", "exposed_copper_door"), Blocks.COPPER_BLOCK), WeatherState.EXPOSED);
		Block tallWeatheredCopperDoor =  new TallWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("copperandtuffbackport", "weathered_copper_door"), Blocks.COPPER_BLOCK), WeatherState.WEATHERED);
		Block tallOxidizedCopperDoor = new TallWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("copperandtuffbackport", "oxidized_copper_door"), Blocks.COPPER_BLOCK), WeatherState.OXIDIZED);
		Block tallWaxedCopperDoor = new TallWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("copperandtuffbackport", "waxed_copper_door"), Blocks.COPPER_BLOCK), WeatherState.UNAFFECTED);
		Block tallWaxedExposedCopperDoor = new TallWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("copperandtuffbackport", "waxed_exposed_copper_door"), Blocks.COPPER_BLOCK), WeatherState.EXPOSED);
		Block tallWaxedWeatheredCopperDoor = new TallWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("copperandtuffbackport", "waxed_weathered_copper_door"), Blocks.COPPER_BLOCK), WeatherState.WEATHERED);
		Block tallWaxedOxidizedCopperDoor = new TallWeatheringDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("copperandtuffbackport", "waxed_oxidized_copper_door"), Blocks.COPPER_BLOCK), WeatherState.OXIDIZED);
	...
	private static void registerRecipes(CompatChecker checker) {
		if (Compats.isModLoaded("tricky_trials", checker)) {
			...
			DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_WAXED_COPPER, new ResourceLocation("tricky_trials", "copper_door"), "tall_copper_door");
			DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_WAXED_EXPOSED_COPPER, new ResourceLocation("tricky_trials", "waxed_exposed_copper_door"), "tall_copper_door");
			DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_WAXED_WEATHERED_COPPER, new ResourceLocation("tricky_trials", "waxed_weathered_copper_door"), "tall_copper_door");
			DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_WAXED_OXIDIZED_COPPER, new ResourceLocation("tricky_trials", "waxed_oxidized_copper_door"), "tall_copper_door");
		}
		if (Compats.isModLoaded("trials", checker)) {
			...
			DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_WAXED_COPPER, new ResourceLocation("trials", "waxed_copper_door"), "tall_copper_door");
			DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_WAXED_EXPOSED_COPPER, new ResourceLocation("trials", "waxed_copper_door_exposed"), "tall_copper_door");
			DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_WAXED_WEATHERED_COPPER, new ResourceLocation("trials", "waxed_copper_door_weathered"), "tall_copper_door");
			DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_WAXED_OXIDIZED_COPPER, new ResourceLocation("trials", "waxed_copper_door_oxidized"), "tall_copper_door");
		}
		if (Compats.isModLoaded("copperandtuffbackport", checker)) {
			...
			DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_WAXED_COPPER, new ResourceLocation("copperandtuffbackport", "copper_door"), "tall_copper_door");
			DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_WAXED_EXPOSED_COPPER, new ResourceLocation("copperandtuffbackport", "waxed_exposed_copper_door"), "tall_copper_door");
			DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_WAXED_WEATHERED_COPPER, new ResourceLocation("copperandtuffbackport", "waxed_weathered_copper_door"), "tall_copper_door");
			DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_WAXED_OXIDIZED_COPPER, new ResourceLocation("copperandtuffbackport", "waxed_oxidized_copper_door"), "tall_copper_door");
		}
	}
}
