...
public class MyNethersDelightCompat 
{
	...
	private static void registerBlocksItems() {
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_POWDERY, DDNames.SHORT_POWDERY, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("mynethersdelight", "powdery_door")), true, DDRegistry.MAIN_TAB);
	}
