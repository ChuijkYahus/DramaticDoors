...
public class TropicraftCompat 
{
	...
	private static void registerBlocksItems() {
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_TC_BAMBOO, DDNames.SHORT_TC_BAMBOO, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("tropicraft", "bamboo_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_TC_MAHOGANY, DDNames.SHORT_TC_MAHOGANY, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("tropicraft", "mahogany_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_TC_MANGROVE, DDNames.SHORT_TC_MANGROVE, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("tropicraft", "mangrove_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_TC_PALM, DDNames.SHORT_TC_PALM, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("tropicraft", "palm_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_TC_THATCH, DDNames.SHORT_TC_THATCH, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("tropicraft", "thatch_door")), true, DDRegistry.MAIN_TAB);
	}
